...
xhr.onload = function () {
    ...
    image.setAttribute('src', "https://static.standard.co.uk/s3fs-public/thumbnails/image/2020/02/19/09/big-fernand-1902g.JPG?width=968");
    document.body.appendChild(image);
	
	lineBreak = document.createElement('br');
	document.body.appendChild(lineBreak);

	var rname = ObjectData[22].restaurant;
